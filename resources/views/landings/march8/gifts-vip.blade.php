                ...
                <div class="popup__content">
                    ...
                    <div class="contact__form-sertificate">
                        <label for="item1" class="sertificate__item js-gift-choice"
                               data-item-id="10"
                               data-item-count="{{ $giftCountsByTypes['letual_vip'] }}">
                        ...
                        <label for="item20" class="sertificate__item js-gift-choice"
                               data-item-id="18"
                               data-item-count="{{ $giftCountsByTypes['fitmost'] }}">
								<span class="sertificate__item-text">
									Eдиный фитнес-абонемент<br> в студии по всей стране<br> на 1 месяц
								</span>
                            <input type="radio" id="item6" name="item-three">
                            <span class="sertificate__item-image">
									<picture><source srcset="{{ asset('march8/img/fitmost.webp') }}" type="image/webp">
                                        <img src="{{ asset('march8/img/fitmost.png') }}" alt="fitmost"></picture>
								</span>
                        </label>
                        ...
                        <label for="item3" class="sertificate__item js-gift-choice"
                               data-item-id="8"
                               data-item-count="{{ $giftCountsByTypes['tayray_vip'] }}">
								<span class="sertificate__item-text">
                ...
                <div class="popup__content">
                    ...
                    <div class="contact__form-sertificate">
                        <label for="item4" class="sertificate__item js-gift-choice"
                               data-item-id="2"
                               data-item-count="{{ $giftCountsByTypes['lamoda_vip'] }}">
								<span class="sertificate__item-text">
                        ...
                        <label for="item5" class="sertificate__item js-gift-choice"
                               data-item-id="4"
                               data-item-count="{{ $giftCountsByTypes['defile_vip'] }}">
								<span class="sertificate__item-text">
                        ...
                        <label for="item6" class="sertificate__item js-gift-choice"
                               data-item-id="14"
                               data-item-count="{{ $giftCountsByTypes['ozon_vip'] }}">
								<span class="sertificate__item-text">
                ...
                <div class="popup__content">
                    ...
                    <div class="contact__form-sertificate">
                        <label for="item7" class="sertificate__item js-gift-choice"
                               data-item-id="12"
                               data-item-count="{{ $giftCountsByTypes['karo_vip'] }}">
								<span class="sertificate__item-text">
                        ...
                        <label for="item10" class="sertificate__item js-gift-choice"
                               data-item-id="6"
                               data-item-count="{{ $giftCountsByTypes['ticketland_vip'] }}">
								<span class="sertificate__item-text">
